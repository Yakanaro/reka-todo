...
{{--        <div class="container mt-3 bg-white rounded-3 shadow d-flex flex-row mb-2" style="min-height: 200px;" id="test">--}}
...
{{--                <button type="button" class="mb-3 btn btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#addTag">Добавить теги</button>--}}
{{--                <button type="button" class="mr-3 btn btn-outline-danger" data-id="{{ $taskList->id }}">Удалить список</button>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    @endforeach--}}
{{--    @include('tags.new')--}}
...
<script>
    $(document).ready(function() {
        $('.taskListContainer').on('click', '.btn-outline-danger', function() {
            let id = $(this).data("id");
            let token = $("meta[name='csrf-token']").attr("content");
            let parent = $(this).closest(".container.mt-3"); // Adapted the selector here
